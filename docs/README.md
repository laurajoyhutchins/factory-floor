...
- [Measured verification cadence](reference/verification-cadence.md)
- [Test and coverage evidence](reference/test-and-coverage-evidence.md)
- [Milestone 1 acceptance timing baseline](reference/m1-acceptance-baseline.json)
...
- The runtime contract, architecture decisions, worker protocol, worker SDK conformance rules, compatibility ledger, operator API, template-instantiation protocol, verification cadence, test and coverage evidence rules, and conformance ledger are current normative references.
